...
public:
    ...
    bool loadMedia(LTexture& spriteSheetTexture, std::string& path, std::array<SDL_Rect, LButtonSprite::BUTTON_SPRITE_TOTAL>& spriteClips, std::array<LButton, LButtonSprite::BUTTON_SPRITE_TOTAL>& buttonsArray);
